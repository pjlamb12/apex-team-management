...
export class PresetPickerModal {
  ...
  readonly soccerPresets: PresetFormation[] = [
    ...
    },
    {
      ...
      sport: 'soccer',
      pitchType: 'full_pitch',
      description: 'Standard 9v9 youth formation with 3 backs, 3 midfielders, and 2 central forwards.',
      tokens: [
        { id: '1', label: '1', role: 'GK', team: 'home', x: 8, y: 50 },
        { id: '2', label: '2', role: 'RB', team: 'home', x: 26, y: 78 },
        { id: '3', label: '4', role: 'CB', team: 'home', x: 23, y: 50 },
        { id: '4', label: '3', role: 'LB', team: 'home', x: 26, y: 22 },
        { id: '5', label: '7', role: 'RM', team: 'home', x: 48, y: 78 },
        { id: '6', label: '8', role: 'CM', team: 'home', x: 45, y: 50 },
        { id: '7', label: '11', role: 'LM', team: 'home', x: 48, y: 22 },
        { id: '8', label: '9', role: 'RS', team: 'home', x: 72, y: 62 },
        { id: '9', label: '10', role: 'LS', team: 'home', x: 72, y: 38 },
    ...
    },
    {
      ...
      tokens: [
        { id: '1', label: '1', role: 'GK', team: 'home', x: 8, y: 50 },
        { id: '2', label: '2', role: 'RB', team: 'home', x: 25, y: 80 },
        { id: '3', label: '4', role: 'CB', team: 'home', x: 22, y: 50 },
        { id: '4', label: '3', role: 'LB', team: 'home', x: 25, y: 20 },
        { id: '5', label: '7', role: 'RM', team: 'home', x: 50, y: 82 },
        { id: '6', label: '6', role: 'CM', team: 'home', x: 44, y: 60 },
        { id: '7', label: '8', role: 'CM', team: 'home', x: 44, y: 40 },
        { id: '8', label: '11', role: 'LM', team: 'home', x: 50, y: 18 },
        { id: '9', label: '9', role: 'ST', team: 'home', x: 74, y: 50 },
