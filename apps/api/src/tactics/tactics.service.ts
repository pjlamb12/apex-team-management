  ...
  async seedPresets(coachId: string, sport: string): Promise<TacticPlayEntity[]> {
    ...
    if (normalizedSport === 'soccer') {
      const presets: CreateTacticPlayDto[] = [
        ...
        {
          title: '9v9 Formation (1-3-3-2)',
          description: 'Standard 9v9 youth formation with 3 backs, 3 midfielders, and 2 forwards.',
          sport: 'soccer',
          category: 'formation',
          pitchType: 'full_pitch',
          tags: ['9v9', '1-3-3-2', '3-3-2', 'Youth'],
          notes: 'Outside backs provide width while central midfield links defense to twin forwards.',
          canvasData: {
            pitchType: 'full_pitch',
            tokens: [
              { id: 't1', label: '1', role: 'GK', team: 'home', x: 8, y: 50 },
              { id: 't2', label: '2', role: 'RB', team: 'home', x: 26, y: 78 },
              { id: 't3', label: '4', role: 'CB', team: 'home', x: 23, y: 50 },
              { id: 't4', label: '3', role: 'LB', team: 'home', x: 26, y: 22 },
              { id: 't5', label: '7', role: 'RM', team: 'home', x: 48, y: 78 },
              { id: 't6', label: '8', role: 'CM', team: 'home', x: 45, y: 50 },
              { id: 't7', label: '11', role: 'LM', team: 'home', x: 48, y: 22 },
              { id: 't8', label: '9', role: 'RS', team: 'home', x: 72, y: 62 },
              { id: 't9', label: '10', role: 'LS', team: 'home', x: 72, y: 38 },
              { id: 'ball', label: '', team: 'ball', x: 45, y: 53 },
            ],
            drawings: [],
          },
        },
        {
          title: '9v9 Formation (1-3-4-1)',
          description: 'Midfield-dominant 9v9 formation with 3 backs, 4 midfielders, and 1 lone striker.',
          sport: 'soccer',
          category: 'formation',
          pitchType: 'full_pitch',
          tags: ['9v9', '1-3-4-1', '3-4-1', 'Midfield', 'Youth'],
          notes: 'Dominates possession in midfield with width provided by wingers and support for the striker.',
          canvasData: {
            pitchType: 'full_pitch',
            tokens: [
              { id: 't1', label: '1', role: 'GK', team: 'home', x: 8, y: 50 },
              { id: 't2', label: '2', role: 'RB', team: 'home', x: 25, y: 80 },
              { id: 't3', label: '4', role: 'CB', team: 'home', x: 22, y: 50 },
              { id: 't4', label: '3', role: 'LB', team: 'home', x: 25, y: 20 },
              { id: 't5', label: '7', role: 'RM', team: 'home', x: 50, y: 82 },
              { id: 't6', label: '6', role: 'CM', team: 'home', x: 44, y: 60 },
              { id: 't7', label: '8', role: 'CM', team: 'home', x: 44, y: 40 },
              { id: 't8', label: '11', role: 'LM', team: 'home', x: 50, y: 18 },
              { id: 't9', label: '9', role: 'ST', team: 'home', x: 74, y: 50 },
              { id: 'ball', label: '', team: 'ball', x: 44, y: 52 },
            ],
            drawings: [],
          },
        },
